...
from tdmpc_square.tdmpc_square.tdmpc_square import TDMPC2
...
# python -m tdmpc_square.train disable_wandb=False exp_name=tdmpc task=humanoid_h1hand-sit_simple-v0 seed=0
